import { ClientAPI, logger } from "panoptyk-engine/dist/client";
import { FollowStrategy } from "./followStrategy";

// Boilerplate agent code ================================================== START
const username = process.argv[2] ? process.argv[2] : "fBot";
...
const fStrat: FollowStrategy = new FollowStrategy();
