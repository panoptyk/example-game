...
import { TraderLeaderStrategy } from "./traderLeaderStrategy";
  ...
  const traderLeaderStrategy: TraderLeaderStrategy = new TraderLeaderStrategy();

  async function act() {
     await traderLeaderStrategy.act();
