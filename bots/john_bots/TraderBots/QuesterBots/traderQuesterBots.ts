...
import { TraderQuesterStrategy } from "./traderQuesterStrategy";
import { TraderLeaderStrategy } from "../LeaderBots/traderLeaderStrategy";
  ...
  const traderQuesterStrategy: TraderQuesterStrategy = new TraderLeaderStrategy();

  async function act() {
    await traderQuesterStrategy.act();
